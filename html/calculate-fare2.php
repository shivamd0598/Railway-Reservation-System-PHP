...
if(!isset($_SESSION['uname']))
   ...
   if(isset($_POST['submit-btn']))
       ...
       /*$frm_stn =$_GET['From_Stations'];
            ...
            header("location:calculate-fare3.php");
   }
             
                
if(isset($_POST['back-btn']))
{
    header('location:calculate-fare1.php');
}   
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8" id="train-select">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">CHOOSE A TRAIN:<br><br></h2>
    ...
    <?php            
     ...
     <option value="Jammu Rajdhani"> Jammu Rajdhani</option>   
            ...
            <br>
                ...
                <div class="mbr-section-btn align-center"><input type="submit" value="Show Details" name="Show-btn" id="show-details-btn"  class="btn btn-primary"  >            <input type="submit" value="Submit" id="submit" name="submit-btn" class="btn btn-primary" >
