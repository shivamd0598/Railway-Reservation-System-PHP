...
<section class="engine"><a href="https://mobirise.me/y">free html web templates</a></section><section class="mbr-section content5 cid-qRRrCtjBBH" id="content5-13">
        ...
        <td>Total Fare</td>      
              ...
              <?php 
                ...
                if($cnt==0)
                {
                    ...
                    <br>
                    <br>
                      <input type="submit" value="Cancel Ticket" id="cancel-button" name="cancel-btn"class="btn btn-primary" >
