    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4">TOUR N TRAVELS</a></span>
            </div>
        </div>
...
<section class="mbr-section content5 cid-qRPmL8X7kI" id="content5-t">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8" id="train-select">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">Search Result:<br><br></h2>
  ...
  <?php
            if(isset($_SESSION['train_name']))
            {
                ...
                echo "<h1 style=color:red; font-size:2em; background-color:black; text-align:center;> Train Found: </h1>";   
                echo"<br>";
                
                echo "<h1 style=color:red; font-size:2em; background-color:black; text-align:center;>".$_SESSION['train_name']."</h1>";   
            }
                     
                      
        else
        {
            echo "<h1 style=color:red; font-size:2em; background-color:black; text-align:center;> Train NOT Found: </h1>";  
        }
 ...
 <?php  
        ...
        {
        $stnval=$_SESSION['stn-val'];    
        $train_name=$_SESSION['train_name'];    
        $sql2="SELECT * from $stnval where train_name='$train_name'";
