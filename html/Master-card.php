...
if(isset($_POST['pay-btn']))
 ...
 if($input_cardno!=null && $input_cvv!=null)
 {
     ...
     $borad_stn=$_SESSION['frm_stn'];
     $dest_stn=$_SESSION['to_stn'];
  ...
  <div class="container-fluid">
     ...
     <div class="row">
       ...
       <div class="row" id="login">
         ...
         <div class="col-sm-12" >
            <form method="post" name="form1" onsubmit="return cardnumber(); return validatecss();">
              ...
              <h2>Card Number:</h2>
                ...
                <input type="text" name="card_no" id="cardno" placeholder="Enter your Credit/Debit Card Number" > <br>   
                 <h2>Expiry Date:</h2> 
              ...
              <input id="date" type="date"> <br>
                   ...
                   <h2>CVV:</h2>
                   <input type="text" name="cvv" id="cvv" placeholder="Enter Pin Number">
                   <br>
           ...
           ?>
                    ...
                    <br>
                    <br>
                    <input type="submit" value="Pay" id="submit" name="pay-btn" onclick="validatedata()">
