...
if(!isset($_SESSION['uname']))
   {
    ...
    if(isset($_POST['prcd-paybtn']))
    {
        ...
        {
            header("location:American-card1.php");
        }
        
       elseif($_POST['cards']=='Master Card')
        {
            header("location:Master-card1.php");
        }
        
        elseif($_POST['cards']=='Visa Card')
        {
            header("location:Visa-card1.php");
        }
...
<section class="mbr-section content5 cid-qRRDwKoRTc" id="content5-1a">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2">Available Cards:</h2>
