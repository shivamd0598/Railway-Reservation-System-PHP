...
if($date < $now) {
   ...
   // $_SESSION['to_stn']= $to_stn; 
    ...
    header("location: search-train-stns-res.php");
...
<section class="mbr-section content5 cid-qRPeyvvmUR" id="content5-q">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
               <form method="post">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2">CHOOSE STATIONS</h2>
            ...
            <option value="None"> --Select One-- </option>    
                ...
                <br><br></p>
                <div class="mbr-section-btn align-center"><input type="submit" value="Submit" name="submit-btn"       class="btn btn-primary"     id="submit-btn" >
