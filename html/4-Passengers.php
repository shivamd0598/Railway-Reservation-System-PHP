...
if(isset($_POST['prcd-paybtn']))
{
    ...
    if($pname1!=null && $pname2!=null && $pname3!=null && $pname4!=null)
    {
    header('location:choose-card1.php');
    ...
    else
     {
        ...
        window.location='4Passenger-details.php';
        </script>";
...
<body>
  <section class="menu cid-qROB0Xmn7t" once="menu" id="menu1-y">
...
<section class="engine"><a href="https://mobirise.me/u">bootstrap website templates</a></section><section class="mbr-section content5 cid-qRRDwz5ddh" id="content5-19">
...
<section class="mbr-section content5 cid-qRRDwKoRTc" id="content5-1a">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-2">Passenger Details:</h2>
...
<option value="None"> --Select One-- </option>    
            ...
            <option value="None"> --Select One-- </option>    
               ...
               <tr>
                 ...
                 <td> <input type="text" name="tname3" id="tname3" placeholder="Enter 3rd Pessanger Name"></td> 
...
<option value="None"> --Select One-- </option>    
            ...
            <option value="None"> --Select One-- </option>    
                ...
                <option value="f">Female</option>    
                 ...
                 <td> <input type="text" name="tname4" id="tname4" placeholder="Enter 4th Pessanger Name"></td> 
