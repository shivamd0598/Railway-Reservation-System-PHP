...
if(isset($_POST['prcd-paybtn']))
{
   ...
   header('location:choose-card1.php');
    ...
    else
     {
        ...
        window.location='2Passenger-details.php';
        </script>";
...
<body>
  <section class="menu cid-qROB0Xmn7t" once="menu" id="menu1-w">
...
<section class="engine"><a href="https://mobirise.me/y">free html website templates</a></section><section class="mbr-section content5 cid-qRRDnDSvi9" id="content5-15">
...
<section class="mbr-section content5 cid-qRRDo6j6lA" id="content5-16">
