...
{
    header('location:search-train-stns.php');
}   
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">Search Available Trains</h2>
...
<section class="mbr-section content5 cid-qRPmL8X7kI" id="content5-t">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8" id="train-select">
                <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-1">AVAILABLE TRAINS:<br><br></h2>
  ...
  <br>
  <?php
           /*  echo "<h1 style=color:red; font-size:2em; background-color:black; text-align:center;>".$_SESSION['frm_stn']."-".$_SESSION['to_stn']."</h1>";  
             */
                     
                     echo "<h1 style=color:red; font-size:2em; background-color:black; text-align:center;>From Station: ".$_SESSION['frm_stn']."</h1>";
                     
                    echo "<h1 style=color:red; font-size:2em; background-color:black; text-align:center;>To Station: ".$_SESSION['to_stn']."</h1>";
...
<br>
   ...
   <select name="available_trains" id="drop-menu">
    <?php
    ...
    <?php            
     ...
     <option value="Jammu Rajdhani"> Jammu Rajdhani</option>   
            ...
            <br>
                ...
                <div class="mbr-section-btn align-center"><input type="submit" value="Show Details" name="Show-btn" id="show-details-btn"  class="btn btn-primary"  >            
