...
if(isset($_POST['search-btn']))
{
        ...
        $train_no=$_POST['train-no'];
    
    
    $sql1="SELECT * from jammudelhi where train_no='$train_no'";
    ...
    if($row1=mysqli_fetch_array($result1))
   {
    ...
    {
         $sql2="SELECT * from delhijammu where train_no='$train_no'";
    ...
    if($row2=mysqli_fetch_array($result2))
   {
    ...
    {
         $sql3="SELECT * from jammuamritsar where train_no='$train_no'";
    ...
    if($row3=mysqli_fetch_array($result3))
   {
    ...
    {
         $sql4="SELECT * from amritsarjammu where train_no='$train_no'";
    ...
    if($row4=mysqli_fetch_array($result4))
   {
    ...
    {
         $sql5="SELECT * from delhiamritsar where train_no='$train_no'";
    ...
    if($row5=mysqli_fetch_array($result5))
   {
    ...
    {
         $sql6="SELECT * from amritsardelhi where train_no='$train_no'";
    ...
    if($row6=mysqli_fetch_array($result6))
   {
    ...
    {
         $sql7="SELECT * from jammumumbai where train_no='$train_no'";
    ...
    if($row7=mysqli_fetch_array($result7))
   {
    ...
    {
         $sql8="SELECT * from mumbaijammu where train_no='$train_no'";
    ...
    if($row8=mysqli_fetch_array($result8))
   {
    ...
    {
         $sql9="SELECT * from amritsarmumbai where train_no='$train_no'";
    ...
    if($row9=mysqli_fetch_array($result9))
   {
    ...
    {
         $sql10="SELECT * from mumbaiamritsar where train_no='$train_no'";
    ...
    if($row10=mysqli_fetch_array($result10))
   {
    ...
    {
         $sql11="SELECT * from delhimumbai where train_no='$train_no'";
    ...
    if($row11=mysqli_fetch_array($result11))
   {
    ...
    {
         $sql12="SELECT * from mumbaidelhi where train_no='$train_no'";
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8" id="train-select">
                ...
                <h2 style="color:crimson; text-align:center">Search using Train Number:-</h2><br>
                 <form method="post" >
             
               <label style="color:mediumseagreen; font-size:24px;">Enter Train Numeber:</label>
     
  
            <br>
             <input type="text" name="train-no" id="" placeholder="Enter Train Number" style="color:mediumseagreen; background-color:darkblue; font-size:28px;" >
