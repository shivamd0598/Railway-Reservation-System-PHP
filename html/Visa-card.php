    ...
    $input_cardno=$_POST['card_no'];
     ...
     if($input_cardno!=null && $input_cvv!=null)
     {
        ...
        $sql1="INSERT INTO $username(sno,train_name,train_no,fare,class,boarding_stn,destination_stn,date_journey) VALUES(NULL,'$train_name','$train_num','$total_fare','$train_class','$board_stn','$dest_stn','$d_journey')";
         ...
         {//yeh wala else nahi laga rakha tha
            header("location:Payment-successful.php");
         }
         //yaha suddenly beech mein aap code nahi daal sakte
         //nested if-else ya kisi b statement mein......hmm...ok thank u so much:)
    }
    else{    
       echo "<script type='text/javascript'>     
        ...
        } //konsa alert nahi aa rha...hm aagaya...ek aur haiok...isme kya problem thi? else proper nahi tha and wo hi header ka issue......acha...but if lagay tha toh else ke need thi kya? 
    }
